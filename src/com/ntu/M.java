...
public class M extends JFrame {
	 ...
	 */
	public M() {
		setTitle("Addition manufacturer");
		...
		JLabel lblNewLabel = new JLabel("Idm");
		lblNewLabel.setFont(new Font("Tahoma", Font.PLAIN, 17));
		lblNewLabel.setBounds(35, 40, 122, 29);
		contentPane.add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("Manufacturercol");
		...
		lblNewLabel_3.setBounds(35, 120, 122, 29);
		contentPane.add(lblNewLabel_3);
		
		JLabel lblNewLabel_4 = new JLabel("Email");
		lblNewLabel_4.setFont(new Font("Tahoma", Font.PLAIN, 17));
		lblNewLabel_4.setBounds(35, 160, 122, 29);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				long idm =Integer.parseInt(a);
				String Manufacturercol=textField_1.getText();
				String Phone=textField_2.getText();
				String Email=textField_3.getText();
				
				Manufacturer manufacturer=new Manufacturer(idm,Manufacturercol,Phone,Email); 
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					String idm, manufacturercol, phone, email;
					while(rs.next()) {
						idm=rs.getString(1);
						manufacturercol=rs.getString(2);
						phone=rs.getString(3);
						email=rs.getString(4);
						String[] row = {idm, manufacturercol, phone, email};
						model.addRow(row);
					}
